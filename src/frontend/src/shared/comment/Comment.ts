...
export class Comment {
  ...
  @Length(8, 100)
  @IsUrl()
  @Matches(/^https:\/\/b2.shieldlink.io\/file\/[a-zA-Z0-9_.\/-]*|https:\/\/encrypted-tbn0.gstatic.com\/images\?q=[a-zA-Z0-9_.\/:_-]*/, {
    message: 'Image URL must be from shieldlink.io or google',
  })
  titleImage?: string
